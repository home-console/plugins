...
Каждая папка верхнего уровня — это отдельный плагин с собственным `plugin.json`.
Папки, имя которых начинается с `_` или `.` — служебные (CI, скрипты, шаблоны),
они не публикуются в реестр. Структура:
